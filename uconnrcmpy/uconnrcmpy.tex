...
\Cref{fig:residuals} shows a typical plot of the residuals agains the cutoff
...
\mintedinline{python}|UnivariateSpline| from the
\mintedinline{python}|scipy.interpolate| module \autocite{Jones2001} to the
